    ...
    $(document).on('click', '#btn-add-variasi', function () {
        ...
        $('.non-variasi').last().after(
            ...
            <div class="form-group row variasi">
                ...
                <div class="col-lg-7">
                    <button class="btn btn-outline-primary btn-block" id="btn-add-var2">
                        <i class="si si-plus mr-3"></i> Tambah Variasi 2
                    </button>
                    <button class="btn btn-outline-danger btn-block mb-3 mt-0 hide var2-form" id="btn-hapus-var2">
...
function update_variasi(){
    $.ajax({
       type:"POST",
       url: laroute.route('mitra.variasi_update'),
       data: {
