                ...
                <div class="block block-rounded">
                    ...
                    <div class="block-content pb-15">
                        ...
                        <div class="form-group row non-variasi">
                            ...
                            <div class="col-lg-7">
                                <button class="btn btn-outline-primary btn-block" id="btn-add-variasi">
                                    <i class="si si-plus mr-1"></i> Aktifkan Variasi Produk
                                </button>
                                <button class="btn btn-outline-danger btn-block mt-0 hide" id="btn-hapus-variasi">
...
@include('produk::Mitra.produk.include.modal_crop')
...
<script src="{{ asset('assets/modules/produk/js/produk-form.js') }}"></script>
@endpush
