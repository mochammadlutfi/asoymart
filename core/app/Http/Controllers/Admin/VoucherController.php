...
class VoucherController extends Controller
{
    ...
    {
        if($request->voucher_tipe == "total_belanja") {
            return view('admin.voucher.partials.total_belanja');
        }
        elseif($request->voucher_tipe == "produk"){
            return view('admin.voucher.partials.produk');
        }
    }
    ...
    public function simpan(Request $request)
    {
        ...
        if ($validator->fails()){
            ...
            try{
                ...
                $data->tgl_mulai = Carbon::createFromFormat('d-m-Y', $request->tgl_mulai)->format('Y-m-d H:i:s');
                $data->tgl_selesai = Carbon::createFromFormat('d-m-Y', $request->tgl_selesai)->format('Y-m-d H:i:s');
