...
class ProdukController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            $data = Produk::where('bisnis_id', $bisnis_id)->get();
            ...
            ->addColumn('info_produk', function($row){
                ...
                <div class="media-body ml-3">
                    <div class="font-size-h6 font-w700 mb-0"><a href="#">'.ucwords($row->nama).'</a></div>
    ...
    public function edit($produk_id)
    {
        ...
        return view('mitra.produk.edit', compact('produk', 'kategori', 'foto', 'variasi'));
        // }
    }
