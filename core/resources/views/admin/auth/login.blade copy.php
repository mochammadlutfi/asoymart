                ...
                <div class="bg-white">
                    <div class="hero-static content content-full bg-white invisible" data-toggle="appear">
                        ...
                        <div class="py-30 px-5 text-center">
                            <a class="" href="{{ url('/') }}">
                                <img src="{{ asset('assets/img/logo/logo_big.png') }}" width="300px">
                            </a>
                                ...
                                <form method="POST" action="{{ route($loginRoute) }}">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-12">
                                            ...
                                            <input type="text" class="form-control {{ $errors->has('email') ? ' is-invalid' : '' }}" id="login-email" name="email" placeholder="Masukan Username/Email">
                                            @if ($errors->has('email'))
