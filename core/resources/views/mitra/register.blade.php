...
<body>
    <div id="page-container" class="main-content-boxed">
        ...
        <main id="main-container">
            <!-- Page Content -->
            <div class="bg-image" style="background-image: url('{{ asset('assets/img/login_bg.jpg') }}');background-size: unset;">
                    ...
                    <div class="hero-static col-md-6 col-xl-5 d-none d-md-flex align-items-md-end">
                        <div class="p-30 invisible" data-toggle="appear">
                            ...
                            <p class="font-size-h5 text-white">
                                <i class="fa fa-angles-right"></i> Ayo Daftarkan Segara Bisnis Anda!.
                            </p>
                            <p class="font-italic text-white-op">
                                Copyright Warung Asoy &copy; <span class="js-year-copy"></span>
                            </p>
                        </div>
                    </div>
