                ...
                <div class="position-relative">
                    <div class="js-slick-carousel u-slick position-static overflow-hidden u-slick-overflow-visble pb-7 pt-2 px-1"
                        ...
                        <div class="js-slide px-3">
                            <img class="img-fluid" src="https://via.placeholder.com/728x250.png" width="100%"/>
                        </div>
                        @endfor
                    </div>
                </div>
                                        ...
                                        <div class="product-item__body pb-xl-2">
                                            <div class="mb-2">
                                                <a href="../shop/single-product-fullwidth.html" class="d-block text-center">
                                                    <img class="img-fluid" src="https://via.placeholder.com/200x200.png" alt="Image Description">
                                                </a>
                                            </div>
                                            <div class="px-2">
