        ...
        <div class="cart-top_item">
            <ul class="list-unstyled row mx-n2">
                <li class="px-2 col-auto cart-top_img">
                    <img class="img-fluid" src="{{ get_produk_img($cart->produk->fotoUtama) }}" alt="Image Description">
                </li>
                <li class="px-2 col">
...
<div class="text-center">
    <img src="{{ asset('assets/img/placeholder/cart_is_empty.png') }}" alt="empty-basket" class="max-width-200">
