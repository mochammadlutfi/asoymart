                                ...
                                <div class="as-payment-cat px-3 border-bottom border-width-3">
                                    <label for="virtual_account" class="as-payment-cat__label">
                                        <div class="d-flex">
                                            ...
                                            <div class="ml-3 as-payment_body" style="width: 100%;">
                                                    ...
                                                    <div class="d-flex bl-logos__container flex-wrap">
                                                        <div class="d-flex as-payment-method">
                                                            <div class="as-logo-payment border border-gray-15">
                                                                <img src="{{ asset('assets/img/payment/bca.png') }}" alt="bank_bca" class="as-logo-payment__img">
                                                            </div>
                                                        </div>
                                                        <div class="d-flex as-payment-method">
                                                            <div class="as-logo-payment border border-gray-15">
                                                                <img src="{{ asset('assets/img/payment/bni.png') }}" alt="bank_bni" class="as-logo-payment__img">
                                                            </div>
                                                        </div>
                                                        <div class="d-flex as-payment-method">
                                                            <div class="as-logo-payment border border-gray-15">
                                                                <img src="{{ asset('assets/img/payment/mandiri.png') }}" alt="bank_mandiri" class="as-logo-payment__img">
                                                            </div>
                                                        </div>
                                                        <div class="d-flex as-payment-method">
                                                            <div class="as-logo-payment border border-gray-15">
                                                                <img src="{{ asset('assets/img/payment/briva.png') }}" alt="briva" class="as-logo-payment__img">
                                                            </div>
                                                        </div>
                                                        <div class="d-flex as-payment-method">
                                                            <div class="as-logo-payment border border-gray-15">
                                                                <img src="{{ asset('assets/img/payment/permata.png') }}" alt="permata" class="as-logo-payment__img">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group hide">
                                                    ...
                                                    <select class="selectpicker dropdown-select as-dropdown form-control" name="va_bank" title="Pilih Bank Penyedia">
                                                        <option data-content="<img src='{{ asset('assets/img/payment/bca.png') }}'>BCA" value="BCA"></option>
                                                        <option data-content="<img src='{{ asset('assets/img/payment/bni.png') }}'>BNI" value="BNI"></option>
                                                        <option data-content="<img src='{{ asset('assets/img/payment/mandiri.png') }}'>Mandiri" value="Mandiri"></option>
                                                        <option data-content="<img src='{{ asset('assets/img/payment/briva.png') }}'>Briva" value="Briva"></option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="ml-3" style="width: 100%;">
                                                ...
                                                <div class="bl-logos" data-test-logos="">
                                                    <div class="d-flex bl-logos__container flex-wrap">
                                                        ...
                                                        <div class="d-flex as-payment-method">
                                                            <div class="as-logo-payment border border-gray-15">
                                                                <img src="{{ asset('assets/img/payment/mandiri.png') }}" alt="briva" class="as-logo-payment__img">
                                                            </div>
                                                        </div>
                                                        <div class="d-flex as-payment-method">
                                                            <div class="as-logo-payment border border-gray-15">
                                                                <img src="{{ asset('assets/img/payment/permata.png') }}" alt="bank_mandiri" class="as-logo-payment__img">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="ml-3" style="width: 100%;">
                                                ...
                                                <div class="bl-logos" data-test-logos="">
                                                    <div class="d-flex bl-logos__container flex-wrap">
                                                        <div class="d-flex as-payment-method">
                                                            <div class="as-logo-payment border border-gray-15">
                                                                <img src="{{ asset('assets/img/payment/mastercard.png') }}" alt="master_card" class="as-logo-payment__img">
                                                            </div>
                                                        </div>
                                                        <div class="d-flex as-payment-method">
                                                            <div class="as-logo-payment border border-gray-15">
                                                                <img src="{{ asset('assets/img/payment/visa.png') }}" alt="visa" class="as-logo-payment__img">
                                                            </div>
                                                        </div>
                                                        <div class="d-flex as-payment-method">
                                                            <div class="as-logo-payment border border-gray-15">
                                                                <img src="{{ asset('assets/img/payment/jcb.png') }}" alt="jcb" class="as-logo-payment__img">
                                                            </div>
                                                        </div>
                                                        <div class="d-flex as-payment-method">
                                                            <div class="as-logo-payment border border-gray-15">
                                                                <img src="{{ asset('assets/img/payment/american.png') }}" alt="bank_mandiri" class="as-logo-payment__img">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                    ...
                    <div class="card shadow border">
                        ...
                        <div class="card-body">
                            ...
                            <div class="font-size-18 mb-1">
                                ...
                                <span class="text-black float-right total_belanja">{{ currency_frm($data['total']) }}</span>
                            </div>
                            <div class="font-size-18 mb-1">
...
@stop
@push('scripts')
<script src="{{ asset('assets/js/umum/pembayaran.js') }}"></script>
